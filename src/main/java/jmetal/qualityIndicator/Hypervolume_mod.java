...
// }
//
// public double calculateHypervolume(double[][] front, int noPoints, int
// noObjectives) {
//
// int n;
...
// } else {
// tempVolume = calculateHypervolume(front, nonDominatedPoints, noObjectives -
// 1);
// }
//
...
// */
// public double hypervolume(double[][] paretoFront, double[] maximumValues,
// double[] minimumValues) {
//
...
// normalizedFront = utils.getNormalizedFront(paretoFront, maximumValues,
// minimumValues);
//
...
//
// @Override
// public double execute(double[][] paretoFrontApproximation, double[][]
// paretoTrueFront) {
//
