...
import org.ufpr.cbio.poc.operators.custom.IntegerSBXCrossover;
import org.ufpr.cbio.poc.operators.custom.IntegerTwoPointsCrossover;
import org.ufpr.cbio.poc.operators.custom.UniformCrossover;
...
public class CrossoverFactory {
    ...
    public static Crossover getCrossoverOperator(String name, HashMap parameters) throws JMException {
        ...
        else if (name.equalsIgnoreCase("IntegerSBXCrossover"))
            return new IntegerSBXCrossover(parameters);
        else if (name.equalsIgnoreCase("UniformCrossover"))
            return new UniformCrossover(parameters);

        else if (name.equalsIgnoreCase("IntegerTwoPointsCrossover"))
            return new IntegerTwoPointsCrossover(parameters);
        else {
            Configuration.logger_.severe("CrossoverFactory.getCrossoverOperator. " + "Operator '" + name
                + "' not found ");
