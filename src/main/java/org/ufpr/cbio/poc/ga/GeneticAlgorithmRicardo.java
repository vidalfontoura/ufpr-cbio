 ...
 * @author vfontoura
 */
public class GeneticAlgorithmRicardo {
    ...
    public GeneticAlgorithmRicardo(int INDIVIDUE_LENGHT, int POPULATION_SIZE, int GENERATIONS, int MUTATION,
    ...
    public GeneticAlgorithmRicardo() {
