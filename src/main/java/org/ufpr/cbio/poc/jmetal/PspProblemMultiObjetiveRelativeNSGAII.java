 ...
 * @author vfontoura
 */
public class PspProblemMultiObjetiveRelativeNSGAII extends Problem {

    private String proteinChain;
    public static Logger logger_; // Logger object
    public static FileHandler fileHandler_; // FileHandler object

    public PspProblemMultiObjetiveRelativeNSGAII(String solutionType, Integer numberOfVariables) throws ClassNotFoundException {
    ...
    public void evaluate(Solution solution) throws JMException {
        ...
        if (residues.size() != proteinChain.length()) {
            ...
            maxPointsDistance = Double.MAX_VALUE;
        }
    ...
    public static void main(String[] args) throws SecurityException, IOException, JMException, ClassNotFoundException {
        ...
        problem = new PspProblemMultiObjetiveRelativeNSGAII("IntSolution", 98);
        ...
        String acumulatorFileName =
            JMETAL_ALGORITHM_DIR + File.separator + "multi_objetive_%s_%s_%s_%s_%s_%s_%s_nVariables_%s_pop_%s_maxEval_%s.csv";
        String POPULATION_DIR = "Population_multi_ojective";
        ...
        for (int i = 0; i < 50; i++) {
            ...
            outputCSVWriter.writeOutputToCSV(String.format(acumulatorFileName, crossover.getClass().getSimpleName(),
                ...
                String.valueOf(i), String.valueOf(bestIndividue.getObjective(0)), String.valueOf(bestIndividue.getObjective(1)), sb.toString() });
