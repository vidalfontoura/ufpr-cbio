 ...
 * @author user
 */
public class PSPProblemMovementsSingleObjetive extends AbstractProblem {

    private List<Residue> referenceResidues;

    public PSPProblemMovementsSingleObjetive(int numberOfVariables, int numberOfObjectives,
    ...
    public void evaluate(Solution solution) {
        ...
        System.out.println(" Individuo: " + Arrays.toString(intArray).replace(" ", ""));
    ...
    public static void main(String[] args) {
        ...
        NondominatedPopulation result =
            new Executor().withProblemClass(PSPProblemMovementsSingleObjetive.class, 1, 1, referenceResidues)
                .withAlgorithm("MOEAD").withMaxEvaluations(50000).distributeOnAllCores().run();
