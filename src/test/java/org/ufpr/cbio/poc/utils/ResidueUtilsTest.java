...
public class ResidueUtilsTest {
    ...
    public void testUpperLeftCornerMove1() {
        ...
        List<Residue> applySolution = ResidueUtils.applySolution(residues, solution);
    ...
    public void testWith17ResiduesReference() {
        ...
        int[] solution = new int[] { 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3 };
